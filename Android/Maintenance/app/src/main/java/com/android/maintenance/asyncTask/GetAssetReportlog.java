...
import com.android.maintenance.activities.AddServiceEngineerActivity;
 ...
 */
public class GetAssetReportlog extends AsyncTask<String, Void, String> {

    Gson gson;
    private SessionManager session;
    public String token, clientID;
    AddServiceEngineerActivity mActivity;

    public GetAssetReportlog(AddServiceEngineerActivity activity){
    ...
    protected void onPostExecute(String result){
        ...
        try {
            ...
            assignData = obj.getJSONArray("reportLog");
