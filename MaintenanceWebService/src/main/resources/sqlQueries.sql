...
INSERT INTO MACHINE_ATTRIBUTE(company_id,id,m_name,m_desc,rate,rec_status,TYPE) VALUES
(1,1,"HDD","Hard disk",100,"A","MACHINESPARE"),
(1,2,"CD","CD drive",100,"A","MACHINESPARE"),
(1,3,"SDD","SD hard disk",200,"A","MACHINESPARE"),
(1,5,"SERVER","Server machines",NULL,"A", "MACHINETYPE"),
(1,6,"Desktop","Desktop machines",NULL,"A", "MACHINETYPE"),
(1,7,"laptop","laptop machine",NULL,"A", "MACHINETYPE"),
(1,8,"tab","tablets",NULL,"A", "MACHINETYPE"),
(1,9,"HP","hp company product",NULL,"A", "MACHINEMAKE"),
(1,10,"DELL","",NULL,"A", "MACHINEMAKE"),
(1,11,"SONY","",NULL,"A", "MACHINEMAKE"),
(1,12,"HPSLIM","HP SLIM MODEL",NULL,"A", "MACHINEMODEL"),
(1,13,"MACPRO","MAC PRO",NULL,"A", "MACHINEMODEL"),
(1,14,"MACAIR","MAC AIR",NULL,"A", "MACHINEMODEL");
 ...
 */
/**
 * legacy implimentation sql data
 */
