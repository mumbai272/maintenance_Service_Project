 ...
 */
public class AddmachineTypeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.type_addtab);
        ...
        toolbar.setTitle("Create Machine Type");
        ...
        machine = (EditText) findViewById(R.id.machine_type_name);
        description = (EditText) findViewById(R.id.machine_type_desc);

        add = (Button) findViewById(R.id.add_type);
            ...
            public void onClick(View view) {
                ...
                if(Utility.isNotNull(name) && Utility.isNotNull(desc)){
                    ...
                    try{
                        ...
                        new AddMachineTypeAttribute().execute(json);
                        mProgress.show();
                    }catch (Exception e){
                        e.printStackTrace();
                    }
    ...
    private class AddMachineTypeAttribute extends AsyncTask<String, Void, String> {
        @Override
        ...
        protected String doInBackground(String... param) {
            ...
            Log.e("url", "" + ConfigConstant.url + "machine/machinetype");
            result = servicePost.makeServicePostWithToken(ConfigConstant.url + "machine/machinetype",param[0],token);
            return result;
        }
                ...
                alertDialogBuilder
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                intent= new Intent(AddmachineTypeActivity.this,MachineTypeActivity.class);
                                startActivity(intent);
                                finish();
                            }
                        });
