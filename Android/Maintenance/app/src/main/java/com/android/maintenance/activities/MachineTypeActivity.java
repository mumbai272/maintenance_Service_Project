    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                intent = new Intent(MachineTypeActivity.this, AddmachineTypeActivity.class);
                startActivity(intent);
            }
        });

        MachineAttribute attribute= new MachineAttribute(this);
        attribute.execute(ConfigConstant.url+"machine/machinetype?companyId="+ Long.parseLong(companyId));
    }


    public void displayMachineType(JSONArray machineAttr) {
        if(machineAttr==null){
